        ...
        ! function(window) {
            ...
            function SimpleJekyllSearch() {
                ...
                function emptyResultsContainer() {
                    ...
                    document.getElementById('results-ul-container').style.display = "none";
                    //alert(1);
                }
                ...
                function appendToResultsContainer(text) {
                    ...
                    if(checkif == 'no'){
                        ...
                        document.getElementById('results-ul-container').style.display = "block";
                    }
                    console.log(text);
                    //alert(2);
                }
                ...
                function registerInput() {
					...
					//
					var getVal = opt.defaultval;
					if(getVal != ''){
						return 0 == getVal.length ? void emptyResultsContainer() : void render(searcher.search(store, getVal))
					}
					//alert(opt.defaultval);
